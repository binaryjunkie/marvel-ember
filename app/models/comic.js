...
export default DS.Model.extend({
    ...
    digitalId: DS.attr('string'), // (int, optional): The ID of the digital comic representation of this comic. Will be 0 if the comic is not available digitally.,
    title: DS.attr('string'), // (string, optional): The canonical title of the comic.,
    issueNumber: DS.attr('string'), // (double, optional): The number of the issue in the series (will generally be 0 for collection formats).,
    variantDescription: DS.attr('string'), // (string, optional): If the issue is a variant (e.g. an alternate cover, second printing, or director’s cut), a text description of the variant.,
    description: DS.attr('string'), // (string, optional): The preferred description of the comic.,
    ...
    format: DS.attr('string'), // (string, optional): The publication format of the comic e.g. comic, hardcover, trade paperback.,
    pageCount: DS.attr('number'), // (int, optional): The number of story pages in the comic.,
    ...
    thumbnail: DS.attr(), // (Image, optional): The representative image for this comic.,
